...
class Settings(Base, TimestampMixin):
    ...
    text_model: Mapped[str] = mapped_column(String(120), default="gpt-4.1-mini")
    fast_model: Mapped[str] = mapped_column(String(120), default="gpt-4.1-mini")
    quality_model: Mapped[str] = mapped_column(String(120), default="gpt-4.1")
